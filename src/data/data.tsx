...
export const portfolioItems: PortfolioItem[] = [
  ...
  {
    title: 'ReUnite',
    description: 'A comprehensive project that helps university students to buy/sell reusable products at a lower cost. The project is developed using Django, HTML, CSS and Bootstrap.',
    url: 'https://github.com/sivakumarmanoharan/reunite_group_26',
    image: porfolioImage3,
  },
  {
    title: 'Agrosphere',
    description: 'A comprehensive platform which helps small scale farmers to achieve maximum production of crops.',
    url: 'https://github.com/sivakumarmanoharan/Agrosphere',
    image: porfolioImage5,
  },
  {
    title: 'Password Generator',
    description: 'A simple password generator that generates a password based on the length provided',
    url: 'https://github.com/sivakumarmanoharan/password-generator-flask',
    image: porfolioImage7,
  },
  {
    title: 'CropSuitability',
    description: `This initiative aims to empower farmers, entrepreneurs, and investors with data-driven insights for strategic decision-making in agriculture. By analyzing historical crop performance, it seeks to foster sustainable practices, enhance resilience to climate change, and promote prosperity in Canada's rural communities.`,
    url: 'https://github.com/sivakumarmanoharan/A-Data-informed-Evalution-for-crop-suitability-using-Data-Analystics-and-ML',
